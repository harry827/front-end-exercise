var Fireworks = function () {
    ...
    self.init = function () {
        ...
        self.canvasContainer = $('#fireworks');
        ...
        self.canvas.height = self.ch = self.canvasContainer.height() + 50;
    ...
    /* Particle Constructor
     烟花爆炸后的小颗粒的绘制，从draw方法中可以看出，创建几个随机点，烟花颗粒即可在这个范围的随机点中散落。
     */
    /*=============================================================================*/
    ...
    /* Firework Constructor
     创建烟花实例的，我们也可以从draw方法中看出，当我们鼠标点击画布中的某点时，烟花发射的目的地就在那个点上。
     */
    /*=============================================================================*/
